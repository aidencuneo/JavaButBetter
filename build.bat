...
copy /y jbb.jar compiler_versions\%version%\jbb.jar

@REM @REM Copy src_out so that it is used as the new compiler
@REM xcopy /e /y src_out compiler\
