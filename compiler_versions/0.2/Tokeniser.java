...
public class Tokeniser {
    ...
    public static ArrayList < String > splitFile(String file) {
        ...
        for (var i : LangUtil.asIterable(file.length())) {
            ...
            else if (LangUtil.isTruthy((LangUtil.isTruthy(c == '\'')) ? (!LangUtil.isTruthy(((LangUtil.isTruthy(dq)) ? (dq) : ((LangUtil.isTruthy(rb > 0)) ? (rb > 0) : ((LangUtil.isTruthy(sb > 0)) ? (sb > 0) : ((LangUtil.isTruthy(cb > 0)) ? (cb > 0) : (backslash))))))) : (c == '\''))) {
                sq = !LangUtil.isTruthy(sq);
            }
            else if (LangUtil.isTruthy((LangUtil.isTruthy(c == '"')) ? (!LangUtil.isTruthy(((LangUtil.isTruthy(sq)) ? (sq) : ((LangUtil.isTruthy(bt)) ? (bt) : ((LangUtil.isTruthy(rb > 0)) ? (rb > 0) : ((LangUtil.isTruthy(sb > 0)) ? (sb > 0) : ((LangUtil.isTruthy(cb > 0)) ? (cb > 0) : (backslash)))))))) : (c == '"'))) {
                dq = !LangUtil.isTruthy(dq);
            }
            else if (LangUtil.isTruthy((LangUtil.isTruthy(c == '`')) ? (!LangUtil.isTruthy(((LangUtil.isTruthy(sq)) ? (sq) : ((LangUtil.isTruthy(dq)) ? (dq) : ((LangUtil.isTruthy(rb > 0)) ? (rb > 0) : ((LangUtil.isTruthy(sb > 0)) ? (sb > 0) : ((LangUtil.isTruthy(cb > 0)) ? (cb > 0) : (backslash)))))))) : (c == '`'))) {
