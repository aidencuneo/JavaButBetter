...
public class Compiler {
    ...
    public static String compileStatement(ArrayList < Token > tok , String out) {
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.FOR))) ? (((f = findTokenType(tok , Token.Type.IN))) != - 1) : (Extensions.operEq(startTok, Token.Type.FOR)))) {
            out += "for (";
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy(((f = findTokenTypeRev(tok , Token.Type.IF))) != - 1)) ? (Extensions.operEq(findTokenTypeRev(tok , Token.Type.ELSE), - 1)) : (((f = findTokenTypeRev(tok , Token.Type.IF))) != - 1))) {
    ...
    public static String compileExpr(ArrayList < Token > tok , boolean nested) {
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy(((f = findToken(tok , "if"))) != - 1)) ? (((f2 = findToken(tok , "else"))) != - 1) : (((f = findToken(tok , "if"))) != - 1))) {
