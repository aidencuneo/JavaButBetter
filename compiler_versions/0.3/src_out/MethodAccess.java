...
public class MethodAccess {
    ...
    public static AccessMod accessModFromToken(Token tok) {
        if (LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(tok.type, Token.Type.DEFAULT))) ? (Extensions.operEq(tok.type, Token.Type.DEFAULT)) : (tok.value.equals("?")))) { return AccessMod.DEFAULT; }
