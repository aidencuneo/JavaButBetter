    ...
    public static void main(String[] args) {
        ...
        for (var arg : LangUtil.asIterable(args)) {
            if (LangUtil.isTruthy(Extensions.operIn(arg, LangUtil.listOf("-v", "--version")))) {
                LangUtil.println(Extensions.operAdd(Extensions.operAdd("JavaButBetter v", ("0.7.6")), ""));
                LangUtil.exit();
            }
        ...
        if (LangUtil.isTruthy(verbose)) { LangUtil.println(Extensions.operAdd(Extensions.operAdd("--- JavaButBetter v", ("0.7.6")), " ---")); }
