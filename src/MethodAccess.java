...
public class MethodAccess {
    ...
    public static AccessMod accessModFromToken(Token tok) {
        if (LangUtil.isTruthy(tok.value.equals("public") | | tok.value.equals("+"))) { return AccessMod.PUBLIC; }
        if (LangUtil.isTruthy(tok.value.equals("private") | | tok.value.equals("-"))) { return AccessMod.PRIVATE; }
        if (LangUtil.isTruthy(tok.value.equals("protected") | | tok.value.equals("*"))) { return AccessMod.PROTECTED; }
