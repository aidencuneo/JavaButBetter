...
public class Compiler {
    ...
    public static String compileStatement(ArrayList < Token > tok , String out) {
        ...
        else if (LangUtil.isTruthy(((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF)))) ? ((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF))) : (Extensions.operEq(startTok, Token.Type.ELSE)))) ? ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF)))) ? ((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF))) : (Extensions.operEq(startTok, Token.Type.ELSE))) : (Extensions.operEq(startTok, Token.Type.WHILE)))) ? ((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF)))) ? ((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF))) : (Extensions.operEq(startTok, Token.Type.ELSE)))) ? ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF)))) ? ((LangUtil.isTruthy(Extensions.operEq(startTok, Token.Type.IF))) ? (Extensions.operEq(startTok, Token.Type.IF)) : (Extensions.operEq(startTok, Token.Type.ELIF))) : (Extensions.operEq(startTok, Token.Type.ELSE))) : (Extensions.operEq(startTok, Token.Type.WHILE))) : (Extensions.operEq(startTok, Token.Type.UNTIL))))) {
    ...
    public static String compileExpr(ArrayList < Token > tok , boolean nested) {
        ...
        if (LangUtil.isTruthy(!Extensions.operEq(((f = findTokenType(tok, Token.Type.COMMA))), Extensions.operUnarySub(1)))) {
            ...
            if (LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(!LangUtil.isTruthy(localInScope(varname)))) ? (!LangUtil.isTruthy(nested)) : (!LangUtil.isTruthy(localInScope(varname))))) ? (!LangUtil.isTruthy(varname.contains(" "))) : ((LangUtil.isTruthy(!LangUtil.isTruthy(localInScope(varname)))) ? (!LangUtil.isTruthy(nested)) : (!LangUtil.isTruthy(localInScope(varname)))))) {
        ...
        else if (LangUtil.isTruthy(!Extensions.operEq(((f = findAnyTokenRev(tok, List.of("||", "or")))), Extensions.operUnarySub(1)))) {
            String lhs = compileExpr(LangUtil.slice(tok, null, f, 1));
            String rhs = compileExpr(LangUtil.slice(tok, Extensions.operAdd(f, 1), null, 1));
        ...
        else if (LangUtil.isTruthy(!Extensions.operEq(((f = findAnyTokenRev(tok, List.of("&&", "and")))), Extensions.operUnarySub(1)))) {
            String lhs = compileExpr(LangUtil.slice(tok, null, f, 1));
            String rhs = compileExpr(LangUtil.slice(tok, Extensions.operAdd(f, 1), null, 1));
            ...
            if (LangUtil.isTruthy(Extensions.operEq(Extensions.operGetIndex(tok, f).type, Token.Type.EXPR))) {
                ...
                if (LangUtil.isTruthy((LangUtil.isTruthy(StringParser.isPascalCase(Extensions.operGetIndex(tok, Extensions.operUnarySub(2)).value))) ? (!LangUtil.isTruthy(isNew)) : (StringParser.isPascalCase(Extensions.operGetIndex(tok, Extensions.operUnarySub(2)).value)))) {
                    ...
                    LangUtil.println(Extensions.operAdd(Extensions.operAdd(LangUtil.slice(tok, null, Extensions.operUnarySub(1), 1), ", "), name));
                }
    ...
    public static ArrayList < Token > stripMethodAccess(ArrayList < Token > tok , int end) {
        for (var i : LangUtil.asIterable(end)) {
            ...
            var v = t.value;
            if (LangUtil.isTruthy(((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))) ? (!Extensions.operEq(v, "#")) : ((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))))) ? (!Extensions.operEq(v, "instance")) : ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))) ? (!Extensions.operEq(v, "#")) : ((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))))) ? (!Extensions.operEq(v, "^")) : ((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))) ? (!Extensions.operEq(v, "#")) : ((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))))) ? (!Extensions.operEq(v, "instance")) : ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))) ? (!Extensions.operEq(v, "#")) : ((LangUtil.isTruthy(Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE))) ? (!Extensions.operEq(v, "static")) : (Extensions.operEq(MethodAccess.accessModFromToken(t), AccessMod.NONE)))))))) {
