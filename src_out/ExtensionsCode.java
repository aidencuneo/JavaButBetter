...
// >=
bool operGte(int a, int b):
    inline(return a >= b;)

bool operGte(long a, long b):
    inline(return a >= b;)

bool operGte(double a, double b):
    inline(return a >= b;)

// <=
bool operLte(int a, int b):
    inline(return a <= b;)

bool operLte(long a, long b):
    inline(return a <= b;)

bool operLte(double a, double b):
    inline(return a <= b;)
