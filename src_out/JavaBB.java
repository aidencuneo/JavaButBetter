...
class JavaBB {
    public static HashMap<String, String> codeMap = (new HashMap<>(Map.ofEntries()));
    ...
    public static void main(String[] args) {
        ...
        for (var arg : LangUtil.asIterable(args)) {
            if (LangUtil.isTruthy(Extensions.operIn(arg, LangUtil.listOf("-v", "--version")))) {
                LangUtil.println(Extensions.operAdd(Extensions.operAdd("JavaButBetter v", ("0.7.7")), ""));
                LangUtil.exit();
            }
        ...
        if (LangUtil.isTruthy(verbose)) { LangUtil.println(Extensions.operAdd(Extensions.operAdd("--- JavaButBetter v", ("0.7.7")), " ---")); }
        ...
        writeTo(Extensions.operAdd(Extensions.operAdd("", (outDir)), "/Extensions.java"), extensionsRes.getCompiledCode());
        writeTo(Extensions.operAdd(Extensions.operAdd("", (outDir)), "/LangUtil.java"), langUtilRes.getCompiledCode());
