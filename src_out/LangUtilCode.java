...
// none
[T] bool none(T[] v):
    ret false if _ for v
    ret true

[T] bool none(Iterable[T] v, int ... ignore):
    ret false if _ for v
    ret true

[T] bool none(Iterator[T] v, int ... ignore):
    ret false if _ for v
    ret true
...
[T] bool any(Iterable[T] v, int ... ignore):
    ret true if _ for v
    ret false

[T] bool any(Iterator[T] v, int ... ignore):
    ret true if _ for v
    ret false
...
[T] bool all(Iterable[T] v, int ... ignore):
    ret false if !_ for v
    ret true

[T] bool all(Iterator[T] v, int ... ignore):
    ret false if !_ for v
    ret true
