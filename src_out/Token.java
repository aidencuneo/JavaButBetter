...
public class Token {
    ...
    public static Token fromString(String v) {
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(v, "public"))) ? (Extensions.operEq(v, "public")) : (Extensions.operEq(v, "private")))) ? ((LangUtil.isTruthy(Extensions.operEq(v, "public"))) ? (Extensions.operEq(v, "public")) : (Extensions.operEq(v, "private"))) : (Extensions.operEq(v, "protected")))) ? ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(v, "public"))) ? (Extensions.operEq(v, "public")) : (Extensions.operEq(v, "private")))) ? ((LangUtil.isTruthy(Extensions.operEq(v, "public"))) ? (Extensions.operEq(v, "public")) : (Extensions.operEq(v, "private"))) : (Extensions.operEq(v, "protected"))) : (Extensions.operEq(v, "internal")))) {
            t = Type.ACCESS_MOD;
        }
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(v, "import"))) ? (Extensions.operEq(v, "import")) : (Extensions.operEq(v, "include")))) ? ((LangUtil.isTruthy(Extensions.operEq(v, "import"))) ? (Extensions.operEq(v, "import")) : (Extensions.operEq(v, "include"))) : (Extensions.operEq(v, "require")))) ? ((LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(v, "import"))) ? (Extensions.operEq(v, "import")) : (Extensions.operEq(v, "include")))) ? ((LangUtil.isTruthy(Extensions.operEq(v, "import"))) ? (Extensions.operEq(v, "import")) : (Extensions.operEq(v, "include"))) : (Extensions.operEq(v, "require"))) : (Extensions.operEq(v, "use")))) {
            t = Type.IMPORT;
        }
