...
public class Token {
    ...
    public static Token fromString(String v, Token . Type lastToken) {
        ...
        else if (LangUtil.isTruthy(Extensions.operIn(v, LangUtil.listOf("+", "-", "*", "/", "%", "&", "|", "and", "or", "xor", "nor", "&&", "||", "^", "<<", ">>", "<<<", ">>>", ">", "<", ">=", "<=", "==", "!=", "is", "isnt", "isnot", "as", "in", "inside", "notin", "outside")))) {
        ...
        else if (LangUtil.isTruthy((LangUtil.isTruthy(Extensions.operEq(v, "throw"))) ? (Extensions.operEq(v, "throw")) : (Extensions.operEq(v, "raise")))) {
            t = Type.THROW;
        }
