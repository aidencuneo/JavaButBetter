...
public class Tokeniser {
    ...
    public static ArrayList < String > splitFile(String file) {
        ArrayList < String > lines = Extensions.operGt(Extensions.operLt(new ArrayList, ), ());
    ...
    public static ArrayList < Token > tokLine(String line , boolean keepIndent) {
        var tok = Extensions.operGt(Extensions.operLt(new ArrayList, Token), ());
    ...
    public static ArrayList < String > extractArgsFromExpr(String s) {
        var args = Extensions.operGt(Extensions.operLt(new ArrayList, String), ());
    ...
    public static ArrayList < ArrayList < Token > > extractCommaExpr(String s) {
        var elems = Extensions.operGt(Extensions.operGt(Extensions.operLt(Extensions.operLt(new ArrayList, ArrayList), Token), ), ());
        var tok = Tokeniser.tokLine(s.substring(1, Extensions.operSub(s.length(), 1)));
        var current = Extensions.operGt(Extensions.operLt(new ArrayList, Token), ());
        for (var t : LangUtil.asIterable(tok)) {
            if (LangUtil.isTruthy(Extensions.operEq(t.type, Token.Type.COMMA))) {
                elems.add(current);
                current = Extensions.operGt(Extensions.operLt(new ArrayList, Token), ());
            }
    ...
    public static ArrayList < Token . Type > getTokenTypes(ArrayList < Token > tok) {
        var types = Extensions.operGt(Extensions.operLt(new ArrayList, Token.Type), ());
